...
export default function Experience_form9() {
    ...
    const savedata = () => {
        ...
        axios.post(`${BASE_URL}/api/experience/`, data, config)
            ...
            .then((res) => {
                // console.log(res)
                window.localStorage.setItem('data9', JSON.stringify(inputData))
    ...
    return (
        <div>
            {
                addeducations ? <Experience_form10 /> : ""
            }
            <div className='ml-5'>
