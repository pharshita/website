                  ...
                  <div className='d-flex ' style={{ fontSize: "16px" }}>
                    <div style={{ width: "45%", borderRight: "1px solid black" }}>
                      <div className='addressdata pt-5'>
                        <h3><ContactMailIcon sx={{fontSize:"30px"}}/>&nbsp;&nbsp;ADDRESS</h3><br />
                      ...
                      <div className='addressdata'>
                        <h3><SchoolIcon sx={{fontSize:"35px"}}/>&nbsp;&nbsp;EDUCATION</h3><br />
                        <div className='add_containt'>
                        {
                      ...
                      <div className='address1' style={{border:"none"}}>
                      <h3><EngineeringIcon sx={{fontSize:"35px"}}/>&nbsp;&nbsp;SKILLS</h3><br />
                      <div className='add_containt'>
                        <Stack>
                          <div >
                          {
                            ...
                            items.skills.map((skl)=>{
                              return(
                                <div className='mt-3'>
                                <Chip label={skl} sx={{ padding: "10px 10px" }} />
                              </div>
                              )
                            })
                          }
                    ...
                    <div className='' style={{ width: "55%" }}>
                      ...
                      <div className='address1 pt-5'>
                        <h3><WorkIcon sx={{fontSize:"30px"}}/>&nbsp;&nbsp;EXPERIENCE</h3><br />
                        {
                          items.Experience[0] === undefined ? "" :
                      ...
                      <div className='address2'>
                        <h3><DescriptionIcon sx={{fontSize:"35px"}}/>&nbsp;&nbsp;Professional Summary</h3><br />
                        <div className='add_containt'>
