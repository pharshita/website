...
export default function Experience_form11() {
    ...
    const savedata = () => {
        ...
        axios.post(`${BASE_URL}/api/experience/`, data, config)
            ...
            .then((res) => {
                // console.log(res)
                window.localStorage.setItem('data11', JSON.stringify(inputData))
    ...
    return (
        <div>
            {
                addeducations ? <Experience_form12 /> : ""
            }
            <div className='ml-5'>
