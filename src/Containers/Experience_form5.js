...
export default function Experience_form5() {
    ...
    const savedata = () => {
        ...
        axios.post(`${BASE_URL}/api/experience/`, data, config)
            ...
            .then((res) => {
                // console.log(res)
                window.localStorage.setItem('data5', JSON.stringify(inputData))
    ...
    return (
        <div>
            {
                addeducations ? <Experience_form6 /> : ""
            }
              <div className='ml-5'>
