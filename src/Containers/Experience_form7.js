...
export default function Experience_form7() {
    ...
    const savedata = () => {
        ...
        axios.post(`${BASE_URL}/api/experience/`, data, config)
            ...
            .then((res) => {
                // console.log(res)
                window.localStorage.setItem('data7', JSON.stringify(inputData))
    ...
    return (
        <div>
            {
                addeducations ? <Experience_form8 /> : ""
            }
            <div className='ml-5'>
