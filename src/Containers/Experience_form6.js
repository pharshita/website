...
export default function Experience_form6() {
    ...
    const savedata = () => {
        ...
        axios.post(`${BASE_URL}/api/experience/`, data, config)
            ...
            .then((res) => {
                // console.log(res)
                window.localStorage.setItem('data6', JSON.stringify(inputData))
    ...
    return (
        <div>
            {
                addeducations ? <Experience_form7 /> : ""
            }
            <div className='ml-5'>
