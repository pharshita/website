...
const Career = () => {
   ...
   const navigate = useNavigate()
    ...
    useEffect(() => {
        axios.get(`${BASE_URL}/newapp/listjob/`)
            .then((res) => {
    ...
    function handleSubmit() {
        ...
        axios.post('http://127.0.0.1:8000/newapp/jobs/', form1).then((res) => {
            console.log(res)
            setIsLoading(false)
              Toast.fire({
                icon: 'success',
                        ...
                        <div className="row ResumeRow p-5 mb-5 mt-5" style={{background: `url(${require('../../Assets/PNG/whiteline.png')})`,backgroundRepeat:'no-repeat',backgroundSize:'300px',backgroundColor:'#ffaf3e', borderRadius: '20px', boxShadow: '0px 0px 15px #918b84b5' }}>
                            ...
                            <div className="col-lg-8 col-md-8 col-sm-12 " style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                <div className="ResumeMain">
                                    ...
                                    <p>
                                        <EmailIcon  className='team' />&nbsp;&nbsp; <a href="mailto:hr@bridgefix.co"  style={{fontSize:"20px"}}> hr@bridgefix.co </a>
                                    </p>
                                    <p>
                                    <CallIcon  className='team' /> &nbsp;&nbsp;<a href="tel:+919425960946" style={{fontSize:"20px"}}>9425960946</a>
                                    </p>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-4 col-sm-12">
                                <div className="sendResume  p-4" style={{ width: '100%', boxShadow: '0px 0px 15px #00000030', borderRadius: '20px', background: 'white' }}>
                                    ...
                                    <div className="mobile">
                                        <input type="number" className='form-control mt-3 mb-3' value={Contact} onKeyUp={Validatephone} onChange={(e)=>setContact(e.target.value)} placeholder='Mobile Number' name="" id="" />
                                    ...
                                    <div style={{width:'100%',backgroundColor:"#5b1ac3",color:"white",borderRadius:"10px",textAlign:"center",padding:"5px 0px"}} onClick={handleSubmit}>
